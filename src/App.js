...
firebase.initializeApp({
 apiKey: "AIzaSyC_Oqp16X-qbgiApySRzLtC4OBELI4_FBA",
    authDomain: "firechat-c425d.firebaseapp.com",
    projectId: "firechat-c425d",
    storageBucket: "firechat-c425d.appspot.com",
    messagingSenderId: "351034462094",
    appId: "1:351034462094:web:66c3a79f03c81776bededf",
});
      ...
      <div className="flex items-center justify-center shadow-md h-full">
        <div className="flex flex-col items-center justify-center max-w-xl w-full mx-4 p-8 rounded-md shadow-card bg-white dark:bg-coolDark-600 transition-all">
          ...
          <p className="mb-8 text-lg text-center">
            The easiest way to chat with experts all around the world.
          </p>
          <button
